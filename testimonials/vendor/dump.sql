...
-- Дамп структуры для таблица review.reviews
...
-- Дамп данных таблицы review.reviews: ~5 rows (приблизительно)
DELETE FROM `reviews`;
INSERT INTO `reviews` (`id`, `review`, `author_id`, `date`, `active`) VALUES
...
-- Дамп данных таблицы review.users: ~4 rows (приблизительно)
DELETE FROM `users`;
